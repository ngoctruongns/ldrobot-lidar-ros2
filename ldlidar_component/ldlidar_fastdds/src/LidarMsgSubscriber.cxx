...
LidarMsgSubscriber::LidarMsgSubscriber()
...
void LidarMsgSubscriber::SubListener::on_subscription_matched(
        DataReader*,
...
void LidarMsgSubscriber::SubListener::on_data_available(
        DataReader* reader)
{
    // Take data
    LidarMessage st;
